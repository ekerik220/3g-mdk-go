...
type AuthorizeResponse struct {
	...
	ResGiftBalance           string                    `json:"resGiftBalance"`
	ResGiftExpire            string                    `json:"resGiftExpire"`
	KindCode                 string                    `json:"kindCode"`
	JcnTokenResultCode       string                    `json:"jcnTokenResultCode"`
	JcnTokenMemberNum        string                    `json:"jcnTokenMemberNum"`
	JcnTokenVersion          string                    `json:"jcnTokenVersion"`
	JcnTokenResult1          string                    `json:"jcnTokenResult1"`
	JcnTokenResult2          string                    `json:"jcnTokenResult2"`
	JcnTokenResCode          string                    `json:"jcnTokenResCode"`
